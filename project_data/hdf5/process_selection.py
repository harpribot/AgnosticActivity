...
agnostic_files=read_lines('agnostic.txt')
train_files=read_lines('../imsitu/train.txt')
agnostic_files=list(set(agnostic_files)-set(train_files))
print len(agnostic_files)
...
make_hdf5(agnostic_files, '../hdf5/imsitu_agnostic/agnostic_data.h5', True)
